class CartsController < ApplicationController
  ...
  def add_item
    ...
    #redirect_to controller: 'orders', action: 'edit',id: Order.create, post_id: post.id

    # redirect_to post_order_path(post.id)
...
# カート詳細画面から、「削除」を押した時のアクション
  ...
  # def setup_cart_item!
  #   @post_cart = post_carts.find_by(post_id: params[:post_id])
  # end
